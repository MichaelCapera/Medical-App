...
<?php
    ...
    $consultas = ConsultasController::ctrMostrarConsultas($item, $valor);
        ...
        echo '<div class="card  border-0 shadow-sm mb-3 ">
                <div class="card-body position-relative">
                    <div class="media consultas">
                        ...
                        <a href="index.php?page=CrearConcepto&idUsuario='.$value["idUsuario"].'"  class="mb-2 btn btn-sm  btn-default " idUsuario="'.$value["idUsuario"].'" data-target="#modalCrearConcepto" >ver
...
if(isset($_GET["idUsuario"])){
    ...
    $usuario = ConsultasController::ctrMostrarConsultas($item, $valor);

    //echo '<pre>'; print_r($usuario); echo '</pre>';

    $file = $usuario["multimedia"];

    $multimedia = json_decode($file, true);

    //$files = json_decode($multimedia->file);

    //$usuarioMultimedia = $multimedia->file;

    //var_dump($multimedia);

    foreach ($multimedia as $key => $value) {

       //echo '<h1>'.$value["file"].'<h1>';
        ...
        echo   '  <div class="swiper-slide w-auto py-2 pr-2 swiper-slide-active" style="margin-right: 10px;">
                        <div class="card w-250 shadow-sm border-0 position-relative overflow-hidden">
                            <div class="background background-h-100" style="background-image: url(&quot;'.$value["file"].';);">
                            ...
                            <div class="card-body pt-5">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <a href="../'.$value["file"].'" class="btn btn-sm btn-default text-white">Abrir</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card  border-0 shadow-sm mb-3">
                <div class="card-body position-relative">
                        ...
                        <div class="media-body">
                            ...
                            <p class="my-4">Pregunta 1<br>
                                <span class="text-mute">
                                    <?php echo $usuario["pregunta1"]; ?>
                                </span>
                            </p>
                            <p class="my-4">Pregunta 2<br>
                                <span class="text-mute">
                                    <?php echo $usuario["pregunta2"]; ?>
                                </span>
                            </p>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="edad" value=" <?php echo $usuario["edad"]; ?>">

                        <input type="hidden" name="altura" value=" <?php echo $usuario["altura"]; ?>">

                        <input type="hidden" name="peso" value=" <?php echo $usuario["peso"]; ?>">

                        <input type="hidden" name="email" value=" <?php echo $usuario["email"]; ?>">

                        <input type="hidden" name="telefono" value=" <?php echo $usuario["telefono"]; ?>">

                        <input type="hidden" name="caso" value=" <?php echo $usuario["caso"]; ?>">

                        <input type="hidden" name="pregunta1" value=" <?php echo $usuario["pregunta1"]; ?>">

                        <input type="hidden" name="pregunta2" value=" <?php echo $usuario["pregunta2"]; ?>">

                        <input type="hidden" name="multimedia" value=" <?php echo $multimedia; ?>">

                        <br>

                        <input type="text" name="especialista" class="form-control form-control-lg" placeholder="Nombre del especialista" required="Campo Obligatorio para el concepto" >

                        <br>

                        <input type="text" name="especialidad" class="form-control form-control-lg" placeholder="Especialidad" required="Campo Obligatorio para el concepto" >

                        <br>

                        <input type="text" name="ciudad" class="form-control form-control-lg" placeholder="Ciudad" required="Campo Obligatorio para el concepto" >

                        <br>

                        <input type="text" name="pais" class="form-control form-control-lg" placeholder="pais" required="Campo Obligatorio para el concepto" >



                        <br>

                        <span href="#" class="h5 mb-1">Concepto</span>         
                      
                        <textarea name="concepto" class="form-control form-control-lg" placeholder="Concepto" required="Campo Obligatorio para el concepto">
                            </textarea>

                            <?php

                                     $crearConcepto = new ConceptoController();
                                     $crearConcepto->ctrNuevoConcepto(); 
                    ...
                    <h6 class="font-weight-light text-uppercase text-mute text-center">Qué desea hacer?</h6>
                        ...
                        <a href="">
                            <button type="submit" class="mb-2 btn btn-primary">Aceptar</button>
                            </a>
                            <span class="float-right text-secondary text-mute small"></span>
                                <a href="index.php?page=consultaUsuario">

                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 mb-4">
                            ...
                            <div class="form-group">
                                ...
                                echo '<input type = "hidden" value = "'.$_SESSION["id"].'" name = "idUsuario">';
                                ?>
                                <form action="" name="document1" method="post" action="/file-upload"      class="dropzone"  id="my-awesome-dropzone" enctype = "multipart/form-data">


                                 <input type="file" name="file" id="filed" class="d-none">

                                      <h1 class="d-none">Select</h1>
                                 ...
                                 <div class="mb-4">
                                     <button type="submit" class="mb-2 btn btn-default">Guardar</button>
                                 </div>

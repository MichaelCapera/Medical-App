                    ...
                    <div class="row">
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="caso1" type="text" id="pregunta1" class="form-control form-control-lg" placeholder="" required="">
                            </div>
                            ...
                            <div class="form-group">
                               ...
                               <label>¿Tiene algún tipo de alergia?</label>
                                ...
                                <input name="pregunta1" type="text" id="pregunta1" class="form-control form-control-lg" placeholder="" required="">

                                <label>¿Enfermedades hereditarias?</label>

                                <input name="pregunta2" type="text" id="pregunta2" class="form-control form-control-lg" placeholder="" required="">
                                ...
                                <?php
                                     ...
                                     $consulta1 = new ConsultaController1();
                                     $consulta1->ctrConsulta1(); 

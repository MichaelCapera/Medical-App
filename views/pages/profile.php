...
if(isset($_SESSION["id"])){
        ...
        $profile = ProfileController::ctrShowProfile($item, $valor);
      ...
      <div class="container-fluid text-center mb-4">
        ...
        <div class="container mb-4">
            <ul class="nav nav-pills nav-fill justift-content-center mb-4" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="account-tab" data-toggle="tab" href="index.php?page=editarCuenta" role="tab" aria-controls="account" aria-selected="false">
                        Mi información
                    </a>
                </li>

             <!--<li class="nav-item">
                    <a class="nav-link" id="myorders-tab" data-toggle="tab" href="index.php?page=editarCuenta" role="tab" aria-controls="myorders" aria-selected="true">
                        Medica
                    </a>
                </li>
                <li class="nav-item">
...
<div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <p><?php echo $profile["peso"] ?></p>
                            </div>
                        </div>
                          <div class="col-6">
                            <div class="form-group">
                                <label class="text-mute">Estatura</label>
                                <p><?php echo $profile["estatura"] ?></p>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                    ...
                    <a class="mb-2 btn btn-primary" href="index.php?page=editarCuenta">Editar Perfil</a>
                </div>

...
?>
                        ...
                        <div class="card-body position-relative">
                            <div class="media">
                                ...
                                <div class="media-button">
                                    <a id="btnVer" class="mb-2 btn btn-sm  btn-default">Ver</a>
                                </div>
                            </div>
                        </div>
    ...
    =           VÍDEO CONSULTA            =
          ======================================-->
                            ...
                            <div class="card  border-0 shadow-sm">
                                ...
                                <div class="card-footer position-relative">
                                    <div class="row ">
                                        ...
                                        <div class="col-auto align-self-center">
                                            <a id="formulario2" class="btn btn-default text-white" href="index.php?page=consulta1">Seleccionar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
              ...
              <!--=====================================
                ...
                <div id="formulario1" class="container mb-3">
                    ...
                    <div class="row">
                        ...
                        <!--<form role="form" method="post" enctype = "multipart/form-data">-->
                            ...
                            <div class="form-group">
                                ...
                                echo '<input id="idUsuario" type = "hidden" value = "'.$_SESSION["id"].'" name = "idUsuario">';
                                ?>

                            
                                <label>Nombre</label>
                               
                                <input  name="nombre" type="text" id="nombre" class="form-control form-control-lg" placeholder="Ingrese su nombre" required="">

                                <label>Edad</label>
                               
                                <input  name="edad" type="text" id="edad" class="form-control form-control-lg " placeholder="Digite su edad" required="">

                                <label>Altura</label>
                               
                                <input  name="altura" type="text" id="altura" class="form-control form-control-lg " placeholder="Altura en Cm" required="">

                                <label>Peso</label>

                                <input  name="peso" type="text" id="peso" class="form-control form-control-lg " placeholder="Peso en Kg" required="">

                                <label>email</label> 
                               
                                <input  name="email" type="text" id="email" class="form-control form-control-lg " placeholder="Su correo Electrónico" required="">

                                <label>Teléfono</label> 
                               
                                <input  name="telefono" type="text" id="telefono" class="form-control form-control-lg " placeholder="Su número fijo o celular" required="">


                                <h5>Explique su caso aqui</h5>
                                <label for="consulta" class="sr-only">Explique su caso aquí</label>

                                <textarea name="caso" type="text" id="caso" class="form-control form-control-lg" placeholder="Su caso" required=""></textarea>
                               ...
                               <label>¿Pregunta1?</label>
                                ...
                                <input  name="pregunta1" type="text" id="pregunta1" class="form-control form-control-lg" placeholder="Respuesta 1" required="">

                                <label>¿Pregunta 2?</label>

                                <input name="pregunta2" type="text" id="pregunta2" class="form-control form-control-lg" placeholder="Respuesta 2" required="">
                                ...
                                <div class="dropzone multimediaFisica needsclick" >

                                <div class = "dz-message needsclick"  >

                                   Da click o arrastra tus archivos
                                ...
                                <div class="form-group">
                                <button id="ejemplo" type="button" class="mb-2 btn btn-primary">Guardar</button>
                               </div>
    ...
    <script src="views/assets/js/files.js"></script>

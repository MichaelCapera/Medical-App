...
?>
    ...
    <main class="flex-shrink-0 main-container">
        ...
        <div  class="container mb-3">
            <h6 class="page-subtitle">Especialistas</h6>

            <?php

              $especialistas = SpecialistController::ctrShowSpecialists();

            //echo'<pre class="bg-white">'; print_r($especialistas); echo '<pre>';

             ?>

            <?php foreach ($especialistas as $key => $value): ?>
                        ...
                        <div class="card-body position-relative">
                            <div class="media">
                                ...
                                <?php
                                     ...
                                     $consulta = new EspecialistaController2();
                                     $consulta->ctrEspecialista2(); 

                                ?>

                                <div class="media-body">
                                    <h6 class="mb-1">Especialista en <?php echo $value["categoria"]; ?>
                                        
                                    </h6>

                                    <p class="small text-mute"><?php echo $value["especialista"]; ?></p>
                                    ...
                                    <input type="hidden" name="idEspecialista" value=<?php echo $value["id"]; ?>>

                                    <input type="hidden" name="nombreEspecialista" value=<?php echo $value["especialista"]; ?>>

                                     <input type="hidden" name="categoria" value=<?php echo $value["categoria"]; ?>>

                                    <div class="mb-4">
                                        <button type="submit" class=" btn btn-lg btn-default default-shadow btn-block">Consultar<span ></span></button>
                                 </div>  
                                ...
                                <!--<div class="media-button">
                                    <a href="index.php?page=consulta" id="btnVer" class="mb-2 btn btn-sm  btn-default">Ver</a>
                                </div>-->
                            </div>
                        </div>

...
?>
        ...
        <div class="list-group main-menu my-4">
            ...
            <a href="index.php?page=notificacionesUsuario" class="list-group-item list-group-item-action  actualizarNotificaciones" item="nuevoConcepto"><i class="material-icons">notifications</i>Notificaciones <span class="badge badge-dark text-white"><?php echo $notificaciones["nuevoConcepto"] ?></span></a>

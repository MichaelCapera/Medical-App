...
<body class="ui-rounded">
    ...
    <header class="header fixed-top header-fill">
        <nav class="navbar">
           ...
           <div>
                 <!--<a href="index.php?page=register" class=""><span class="avatar avatar-30"><img src="views/assets/img/user1.png" alt=""></span></a>-->
            </div>
        </nav>
    </header>
    <!-- Fixed navbar ends -->
  ...
  <div class="sidebar">
        <div class="row no-gutters">
            ...
            <div class="col-auto align-self-center">
                <a href="index.php?page=register" class="btn btn-link text-white p-2"><i class="material-icons">power_settings_new</i></a>
            </div>
        </div>
        <div class="list-group main-menu my-4">
            ...
            <a href="index.php?page=register" class="list-group-item list-group-item-action"><i class="material-icons">account_circle</i>Setting</a>
        ...
        <div class="container mb-4">
            <div class="card border-0 shadow-light">
                <div class="card-body">
                    ...
                    <div class="tab-pane fade show active was-validated " id="personal" role="tabpanel" aria-labelledby="personal-tab">
                            <h6 class="subtitle">Preguntas</h6>

                        <form method="post" >

                            <div class="form-group" method="post">

                              <label class="text-mute small">Completar</label>
                                 ...
                                 <?php
                                  ...
                                  <input name="nombre1" placeholder="Nombre" type="text" class="form-control" required="" value="">

                                  <input name="apellido1" placeholder="Apellido" type="text" class="form-control" required="" value="">
                                  ...
                                  <?php
                                     ...
                                     $profileUpdate = new MyInfoController();
                                     $profileUpdate->ctrProfileUpdate(); 
                              ...
                              <button type="submit" class=" btn btn-lg btn-default default-shadow btn-block">Siguiente <span class="ml-2 icon arrow_right"></span></button>  
                        ...
                        <div class="tab-pane fade " id="salud" role="tabpanel" aria-labelledby="salud-tab">
                            <div class="form-group">
                                <label class="text-mute small">Completa el formulario anterior </label>
                               
                              </div>

                            <a href="#" class="btn btn-lg btn-default text-white btn-block btn-rounded shadow"><span >Completa nombre y apellido primero</span><i class="material-icons"></i></a>
                        </div>
                        ...
                        <div class="tab-pane fade " id="otras" role="tabpanel" aria-labelledby="otras-tab">
                            <div class="form-group">
                                <label class="text-mute small">Completa el primer formulario</label>
                                
                            <a href="consulta.html" class="btn btn-lg btn-default text-white btn-block btn-rounded shadow"><span>Completa nombre y apellido primero</span><i class="material-icons"></i></a>
                        </div>

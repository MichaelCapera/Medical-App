        ...
        <div class="container mb-4">
            <div class="card border-0 shadow-light">
                <div class="card-body">
                    ...
                    <div class="tab-pane fade show  was-validated " id="personal" role="tabpanel" aria-labelledby="personal-tab">
                        ...
                        <div class="tab-pane fade show active " id="salud" role="tabpanel" aria-labelledby="salud-tab">

                          <form method="post" >

                            <div class="form-group">
                                <label class="text-mute small">Edad </label>
                               ...
                               <input name="edad" type="text" class="form-control" required="" value="" placeholder="ingresar respuesta">

                                <label class="text-mute small">Estatura </label>
                               <input name="estatura" type="text" class="form-control" required="" value="" placeholder="ingresar respuesta Cm">

                                <label class="text-mute small">peso</label>
                               <input name="peso" type="text" class="form-control" required="" value="" placeholder="ingresar respuesta en Kg">

                              </div>

                              <?php

                                     $profileUpdate = new MyInfoController1();
                                     $profileUpdate->ctrProfileUpdate1(); 

                                     

                                ?>

                             <button type="submit" class=" btn btn-lg btn-default default-shadow btn-block">Siguiente <span class="ml-2 icon arrow_right"></span>
                             </button> 
                        ...
                        <div class="tab-pane fade " id="otras" role="tabpanel" aria-labelledby="otras-tab">
                            <div class="form-group">
                                <label class="text-mute small">Debe llenar el formulario anterior</label>
                            
                            <a  class="btn btn-lg btn-default text-white btn-block btn-rounded shadow"><span>Debe llenar sus datos de salud</span><i class="material-icons"></i></a>
                        </div>
